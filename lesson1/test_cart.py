...
def test_add_item_to_cart():
    ...
    text_before = driver.find_element(By.CSS_SELECTOR,
    ...
    text_after = driver.find_element(By.CSS_SELECTOR,
                                     'a[id="item_4_title_link"] > div[class ="inventory_item_name"]').text
...
def test_remove_item_from_cart():
    ...
    cart_before = driver.find_element(By.CSS_SELECTOR, 'a.shopping_cart_link')

    remove_button = driver.find_element(By.CSS_SELECTOR, '#remove-sauce-labs-backpack')
    remove_button.click()

    cart_after = driver.find_element(By.CSS_SELECTOR, 'a.shopping_cart_link')
    assert cart_before != cart_after, 'Item was not removed'
